...
//Điều kiện trong vòng lặp là i <= numbers.length, điều này sẽ làm cho vòng lặp chạy thêm một lần sau khi i vượt qua chỉ số cuối cùng của mảng.
// Điều này sẽ gây ra lỗi vì numbers[numbers.length] sẽ trả về undefined, làm cho phép cộng tổng sai. điều kiện đúng là i< numbers.length
